...
// Временная сложность алгоритма (при строке букв высокого регистра DFSFWESFES) - n * 22 * O(1) ~ 22n.
...
// В худшем случае временная сложность алгоритма (при строке MMMM...) - n(62*7*O(1) + 11*O(1)) ~ 445n.
